...
The IQR for age of invalid tests is `r inline_text(table1, variable = "age", column = "stat_1")`.
 ...
 @tbl-1 includes testing result, gender, age, and day of pendmic testing occured.
...
The @tbl-2 only had one statistically significant characteristic, which was age.
...
ggsave(here::here("figures","dayhist.png"))

```

The @fig-1 varied throughout the pandemic. 
